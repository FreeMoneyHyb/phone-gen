...
test_headers = {}
old_proxies = {
'https': '181.78.27.225:999'
}
geokeys = (['e35aa5dabc1646b6be9da8fbef3ba4d9','ff6f9bf65f6d4eb2a671b36ceedadf9f','962421ffa7f243e6b6b79458aefa38c1'])
...
-------------------
IP DATA : {ba3} {ba1}, {ba2}
Current Api's : Abstract, Proxyscrape 
''')
with open(f"numbers.txt", "w", encoding='utf-8') as file:
  ...
  for i in range(hh):
    ...
    if h.status_code==200:
      ...
      print(f"[!] Key {jmao} Rate Limited Try Using A Vpn ")
